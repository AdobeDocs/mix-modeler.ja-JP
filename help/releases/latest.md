...
| **強化されたパンの限界 ROI/CPA の最適化** | マーケティング予算の経時的な配分方法を改善できます。 計画期間全体にわたって限界的な ROI/CPA を収束させる代わりに、毎月の支出パターンを維持しながら [ 数か月間で最適化 ](/help/plans/build.md) することができます。 | 2025年7月8日（PT） | 2025年7月8日（PT） |
