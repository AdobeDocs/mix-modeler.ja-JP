...
| 列名 | 詳細 |
| ---------------------- | ----------|
| データセット | データセットの名前。  ![ 詳細 ](/help/assets/icons/More.svg) を使用して、データセットのアクションを選択します。 実行できる操作は、次のとおりです。<ul><li>![ プレビュー ](/help/assets/icons/Preview.svg) **[!UICONTROL View]** データセットルールの設定を表示します。 すべてのフィールドが無効になります。</li><li>![ 編集 ](/help/assets/icons/Edit.svg) **[!UICONTROL Edit]** データセットルールの設定を編集します。</li><li>![ 削除 ](/help/assets/icons/Delete.svg) **[!UICONTROL Delete]** データセットルールの設定を削除します。 データセットを削除ダイアログで、削除を確認するプロンプトが表示されます。 データセットルール設定を完全に削除するには、「**[!UICONTROL Delete]**」を選択します。</li><ul> |
