...
* イベントデータ（例：ファーストパーティデータソースから）。 このイベントデータは、Adobe AnalyticsからAdobe Analytics ソースコネクタを介して収集されたデータ、Experience PlatformWeb、モバイルSDK、Edge Network API を介して収集されたデータ、ソースコネクタを使用して取り込まれたデータなどがあります。
