...
様々なチャネルによる貢献度の分布を示すドーナツビジュアライゼーション。 このビジュアライゼーションでは、パフォーマンスが最も高いチャネルのレンズを通じて、増分性を示します。 このビジュアライゼーションは、優先順位付けと予算配分をサポートするのに役立ちます。

ビジュアライゼーションに表示するメディアチャネルを選択できます。

* 有料メディアチャネルのみの貢献に焦点を当てるには、**[!UICONTROL Paid media]**&#x200B;を選択します。
* すべてのチャネルの貢献度を表示するには、**[!UICONTROL All media]**&#x200B;を選択します。
...
* ビジュアライゼーションに目的の&#x200B;**[!UICONTROL Metric]**&#x200B;を設定するには、**[!UICONTROL ROI]** （（収益 – 支出） / 支出）または&#x200B;**[!UICONTROL ROAS]** （収益/支出）のいずれかを選択します。
* 選択した指標の表示方法を設定するには、**[!UICONTROL Show as]**&#x200B;の&#x200B;**[!UICONTROL %]**&#x200B;または&#x200B;**[!UICONTROL $]**&#x200B;を選択します。
...
>title="要因貢献度の分類"
>abstract="要因貢献度の分類は、モデルに含まれる様々な要因に起因するベースコンバージョンの割合を示します。<br/><br/>純粋なベースとは、マーケティングのタッチポイントやモデルに含まれる要因とは無関係に発生する、基になるコンバージョンを表します。 これには、ブランドエクイティ、リピート購入、オーガニック需要、長期的なマーケットトレンドと季節性によって推進されるコンバージョンが含まれます。"
...
>title="タッチポイント位置で分類"
>abstract="このビジュアライゼーションでは、タッチポイントの位置と、すべてのコンバージョンパスをまたいだタッチポイント別に起因するコンバージョンの分類を示します。 ビジュアライゼーションでは、タッチポイントの貢献度が、残りの位置や他の任意の位置のタッチポイントの貢献度よりも高いかどうかを比較します。"
...
>title="モデル適合指標"
>abstract="複数モデルのトレーニング適合指標の概要を示します。"
...
>title="効率測定"
>abstract="アルゴリズムアトリビューションモデルにより生成される効率測定は、タッチポイント量に依存せずに、コンバージョンに対するタッチポイントの相対的な重要度を示します。 これは 1～5 のスケールで測定されます。 タッチポイント量が多いからといって、効率測定が高くなるとは限りません。"


>[!CONTEXTUALHELP]
>id="models_diagnostics_totalvolume"
>title="合計量"
>abstract="合計量は、タッチポイントがユーザーによりタッチされた合計回数です。 また、コンバージョンを達成するパスおよびコンバージョンに結びつかないパスに現れるタッチポイントを含みます。"
...
* **[!UICONTROL Touchpoint effectiveness]** テーブル。アトリビューション AI アルゴリズムモデルの結果を表します。
  ...
  * **[!UICONTROL Efficiency measure]**: アルゴリズムのアトリビューションモデルによって生成された効率性の測定値は、タッチポイントの数に依存せずに、コンバージョンに向けたタッチポイントの相対的な重要性を示します。 効率は1～5のスケールで測定されます。 タッチポイント量が多いからといって、効率測定が高くなるとは限りません。
